namespace Maticsoft.Common
{
    ...
    {
        private static DbHelperSQLP sqlhelp = new DbHelperSQLP(PubConstant.GetConnectionString("ConnectionString"));
        ...
        public static string getPageParameterHidden(ArrayList al)
        {
            ...
            for (int i = 0; i < al.Count; i++)
            {
                try
                {
                    ...
                    string str2 = str;
                    str = str2 + "<input type='hidden' name='" + strArray[0] + "' value='" + strArray[1] + "'>";
                }
                catch
                {
                }
        ...
        {
            string sQLString = "select count(*) as total " + cmd.CommandText;
            return Convert.ToInt32(sqlhelp.Query(sQLString).Tables[0].Rows[0]["total"]);
        }
