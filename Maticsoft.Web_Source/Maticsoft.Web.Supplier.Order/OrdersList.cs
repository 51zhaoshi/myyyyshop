namespace Maticsoft.Web.Supplier.Order
{
    ...
    public class OrdersList : PageBaseSupplier
    {
        ...
        public void BindData()
        {
            ...
            if (!string.IsNullOrWhiteSpace(this.txtOrderCode.Text.Trim()))
            {
                ...
                builder.AppendFormat(" OrderCode like '%{0}%'", InjectionFilter.SqlFilter(this.txtOrderCode.Text.Trim()));
            }
            if (!string.IsNullOrWhiteSpace(this.txtShipName.Text.Trim()))
            {
                ...
                builder.AppendFormat(" ShipName like '%{0}%'", InjectionFilter.SqlFilter(this.txtShipName.Text.Trim()));
            }
            if (!string.IsNullOrWhiteSpace(this.txtBuyerName.Text.Trim()))
            {
                ...
                builder.AppendFormat(" BuyerName like '%{0}%'", InjectionFilter.SqlFilter(this.txtBuyerName.Text.Trim()));
            }
            ...
            if (PageValidate.IsDateTime(this.txtCreatedDateEnd.Text.Trim()) && PageValidate.IsDateTime(this.txtCreatedDateStart.Text.Trim()))
            {
                ...
                builder.AppendFormat(" CreatedDate between  '{0}' and  '{1}' ", InjectionFilter.SqlFilter(this.txtCreatedDateStart.Text.Trim()), InjectionFilter.SqlFilter(this.txtCreatedDateEnd.Text.Trim()));
            }
            if (builder.Length > 1)
            {
                builder.Append(" and ");
            }
            builder.AppendFormat(" SupplierId = {0}", base.CurrentUser.DepartmentID);
