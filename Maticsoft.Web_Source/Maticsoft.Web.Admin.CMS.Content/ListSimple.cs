namespace Maticsoft.Web.Admin.CMS.Content
{
    ...
    public class ListSimple : PageBaseAdmin
    {
        ...
        private void BindTree()
        {
            ...
            DataSet treeList = new ContentClass().GetTreeList(" ClassModel=3 ");
