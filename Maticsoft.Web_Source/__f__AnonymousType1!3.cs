...
[CompilerGenerated]
internal sealed class <>f__AnonymousType1<<controller>j__TPar, <action>j__TPar, <id>j__TPar>
{
    ...
    [DebuggerHidden]
    public <>f__AnonymousType1(<controller>j__TPar controller, <action>j__TPar action, <id>j__TPar id)
    {
    ...
    {
        var type = value as <>f__AnonymousType1<<controller>j__TPar, <action>j__TPar, <id>j__TPar>;
