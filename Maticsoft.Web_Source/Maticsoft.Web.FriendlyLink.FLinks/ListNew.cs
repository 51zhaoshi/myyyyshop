namespace Maticsoft.Web.FriendlyLink.FLinks
{
    ...
    public class ListNew : PageBaseAdmin
    {
        ...
        protected Button btnIsDisplay;
        protected Button btnIsNotDisplay;
        protected Button btnSearch;
        protected DropDownList DropIsDisplay;
        ...
        public void BindData()
        {
            ...
            string selectedValue = this.DropIsDisplay.SelectedValue;
            if ("" != this.DropIsDisplay.SelectedValue)
            {
                builder.AppendFormat("Name like '%{0}%' and IsDisplay='" + selectedValue + "'", this.txtKeyword.Text.Trim());
            }
        ...
        public string fsIsDisplay(object data)
        {
            ...
            {
                return SiteSetting.lblYes;
            }
            return SiteSetting.lblNo;
        }
