namespace Maticsoft.Web.Admin.Shop.ProductType
{
    ...
    public class Modify3 : PageBaseAdmin
    {
        protected int Act_AddData = 0x1f8;
        protected int Act_DelData = 0x1fa;
        protected int Act_UpdateData = 0x1f9;
        ...
        protected HtmlGenericControl spanbtnAddSpec;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                if (!base.UserPrincipal.HasPermissionID(base.GetPermidByActID(this.Act_AddData)) && (base.GetPermidByActID(this.Act_AddData) != -1))
                {
                    this.spanbtnAddSpec.Visible = false;
                }
