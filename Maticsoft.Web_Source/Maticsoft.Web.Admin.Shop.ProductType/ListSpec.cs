namespace Maticsoft.Web.Admin.Shop.ProductType
{
    ...
    public class ListSpec : PageBaseAdmin
    {
        protected int Act_AddData = 0x1fd;
        protected int Act_DelData = 0x1ff;
        protected int Act_UpdateData = 510;
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                base.Response.Redirect(string.Concat(new object[] { "Modify3.aspx?tid=", this.ProductTypeId, "&ed=", this.AttId }));
            }
        }
        ...
        protected void gridView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                this.ptypeBll.SwapSeqManage(null, new long?(this.AttId), new long?(num2), SwapSequenceIndex.Down, true);
            }
            if (e.CommandName == "Rise")
            {
                this.ptypeBll.SwapSeqManage(null, new long?(this.AttId), new long?(num2), SwapSequenceIndex.Up, true);
            }
            this.gridView.OnBind();
        }
