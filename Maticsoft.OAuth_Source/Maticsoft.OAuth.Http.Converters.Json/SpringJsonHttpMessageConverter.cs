namespace Maticsoft.OAuth.Http.Converters.Json
{
    ...
    public class SpringJsonHttpMessageConverter : AbstractHttpMessageConverter
    {
        ...
        public SpringJsonHttpMessageConverter() : this(new Maticsoft.OAuth.Json.JsonMapper())
        {
        }

        public SpringJsonHttpMessageConverter(Maticsoft.OAuth.Json.JsonMapper mapper) : base(new MediaType[] { new MediaType("application", "json") })
        {
            this.mapper = mapper;
        }
