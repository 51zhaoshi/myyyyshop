namespace Maticsoft.ZipLib.Tar
{
    ...
    {
        private string file;
        private Maticsoft.ZipLib.Tar.TarHeader header;

        private TarEntry()
        {
            this.header = new Maticsoft.ZipLib.Tar.TarHeader();
        }
        ...
        {
            Maticsoft.ZipLib.Tar.TarHeader.GetNameBytes(newName, buffer, 0, 100);
        }

        public object Clone()
        {
            return new TarEntry { file = this.file, header = (Maticsoft.ZipLib.Tar.TarHeader) this.header.Clone(), Name = this.Name };
        }
        ...
        public void GetFileTarHeader(Maticsoft.ZipLib.Tar.TarHeader header, string file)
        {
            if (header == null)
            {
                throw new ArgumentNullException("header");
        ...
        public static void NameTarHeader(Maticsoft.ZipLib.Tar.TarHeader header, string name)
        {
            if (header == null)
            {
                throw new ArgumentNullException("header");
        ...
        public Maticsoft.ZipLib.Tar.TarHeader TarHeader
        {
            get
            {
                return this.header;
