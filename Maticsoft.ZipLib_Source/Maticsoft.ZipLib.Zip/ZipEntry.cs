namespace Maticsoft.ZipLib.Zip
{
    ...
    public class ZipEntry : ICloneable
    {
        ...
        private Known known;
        private Maticsoft.ZipLib.Zip.CompressionMethod method;
        private string name;
        private long offset;
        private ulong size;
        ...
        public ZipEntry(string name) : this(name, 0, 0x33, Maticsoft.ZipLib.Zip.CompressionMethod.Deflated)
        {
        }

        internal ZipEntry(string name, int versionRequiredToExtract) : this(name, versionRequiredToExtract, 0x33, Maticsoft.ZipLib.Zip.CompressionMethod.Deflated)
        {
        }
        ...
        public static bool IsCompressionMethodSupported(Maticsoft.ZipLib.Zip.CompressionMethod method)
        {
            return ((method == Maticsoft.ZipLib.Zip.CompressionMethod.Deflated) || (method == Maticsoft.ZipLib.Zip.CompressionMethod.Stored));
        }
        ...
        public Maticsoft.ZipLib.Zip.CompressionMethod CompressionMethod
        {
            get
            {
                return this.method;
        ...
        internal Maticsoft.ZipLib.Zip.CompressionMethod CompressionMethodForHeader
        {
            get
            {
                return ((this.AESKeySize > 0) ? Maticsoft.ZipLib.Zip.CompressionMethod.WinZipAES : this.method);
            }
        }
        ...
        public int Version
        {
            get
            {
                ...
                else
                {
                    ...
                    if (Maticsoft.ZipLib.Zip.CompressionMethod.Deflated == this.method)
                    {
                        return 20;
                    }
                    if (this.IsDirectory)
