namespace Maticsoft.ZipLib.Zip
{
    ...
    using Maticsoft.ZipLib.Zip.Compression.Streams;
    using System;
    ...
    public class ZipOutputStream : DeflaterOutputStream
    {
        ...
        private Maticsoft.ZipLib.Zip.UseZip64 useZip64_;
        ...
        public void PutNextEntry(ZipEntry entry)
        {
            ...
            this.sizePatchPos = -1L;
            if ((this.useZip64_ == Maticsoft.ZipLib.Zip.UseZip64.On) || ((entry.Size < 0L) && (this.useZip64_ == Maticsoft.ZipLib.Zip.UseZip64.Dynamic)))
            {
                entry.ForceZip64();
            }
        ...
        public Maticsoft.ZipLib.Zip.UseZip64 UseZip64
        {
            get
            {
