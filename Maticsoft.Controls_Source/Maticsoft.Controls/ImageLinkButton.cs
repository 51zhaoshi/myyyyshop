namespace Maticsoft.Controls
{
    ...
    public class ImageLinkButton : LinkButton
    {
        ...
        private Maticsoft.Controls.ImagePosition position;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (this.ImagePosition == Maticsoft.Controls.ImagePosition.Right)
            {
        ...
        public Maticsoft.Controls.ImagePosition ImagePosition
        {
            get
            {
