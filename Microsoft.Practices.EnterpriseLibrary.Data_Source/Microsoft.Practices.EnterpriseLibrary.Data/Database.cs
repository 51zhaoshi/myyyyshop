namespace Microsoft.Practices.EnterpriseLibrary.Data
{
    ...
    [ConfigurationNameMapper(typeof(DatabaseMapper)), CustomFactory(typeof(DatabaseCustomFactory))]
    public abstract class Database : IInstrumentationEventProvider
    {
        private Microsoft.Practices.EnterpriseLibrary.Data.ConnectionString connectionString;
        ...
        protected int DoExecuteNonQuery(DbCommand command)
        {
            ...
            {
                this.instrumentationProvider.FireCommandFailedEvent(command.CommandText, this.ConnectionStringNoCredentials, exception);
                throw;
            }
            return num2;
        }
        ...
        internal DbConnection GetNewOpenConnection()
        {
            ...
            try
            {
                ...
                {
                    this.instrumentationProvider.FireConnectionFailedEvent(this.ConnectionStringNoCredentials, exception);
                    throw;
                }
