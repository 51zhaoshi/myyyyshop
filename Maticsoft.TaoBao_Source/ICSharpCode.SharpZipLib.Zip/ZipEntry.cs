namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipEntry : ICloneable
    {
        ...
        public bool CanDecompress
        {
            get
            {
                if ((this.Version > 0x33) || (((this.Version != 10) && (this.Version != 11)) && (((this.Version != 20) && (this.Version != 0x2d)) && (this.Version != 0x33))))
                {
                    return false;
                }
        ...
        internal ICSharpCode.SharpZipLib.Zip.CompressionMethod CompressionMethodForHeader
        {
            get
            {
                ...
                return ICSharpCode.SharpZipLib.Zip.CompressionMethod.WinZipAES;
            }
        }
