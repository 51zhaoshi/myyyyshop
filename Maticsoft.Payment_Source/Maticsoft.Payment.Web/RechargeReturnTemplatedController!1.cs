namespace Maticsoft.Payment.Web
{
    ...
    [Obsolete]
    public abstract class RechargeReturnTemplatedController<T> : Controller where T: class, IRechargeRequest, new()
    {
        ...
        protected void DoValidate()
        {
            ...
            parameters.Add(base.Request.Form);
            parameters.Add(base.Request.QueryString);
            string str = base.Request.Params["MATICSOFTGW"];
