namespace Maticsoft.Payment.PaymentInterface.Alipay
{
    ...
    internal class AlipayNotify : NotifyQuery
    {
        ...
        public override void VerifyNotify(int timeout, PayeeInfo payee)
        {
            ...
            string[] strArray = Maticsoft.Payment.PaymentInterface.Alipay.Globals.BubbleSort(this.parameters.AllKeys);
            string s = "";
            ...
            if (flag && this.parameters["sign"].Equals(Maticsoft.Payment.PaymentInterface.Alipay.Globals.GetMD5(s, this.input_charset)))
            {
