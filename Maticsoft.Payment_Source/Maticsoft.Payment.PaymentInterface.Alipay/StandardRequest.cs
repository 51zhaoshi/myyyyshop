namespace Maticsoft.Payment.PaymentInterface.Alipay
{
    ...
    internal class StandardRequest : PaymentRequest
    {
        ...
        {
            this.RedirectToGateway(Maticsoft.Payment.PaymentInterface.Alipay.Globals.CreatUrl(this.gateway, this.service, this.partner, this.sign_type, this.out_trade_no, this.subject, this.body, this.payment_type, this.price, this.show_url, this.seller_email, this.key, this.return_url, this._input_charset, this.notify_url, this.logistics_type, this.logistics_fee, this.logistics_payment, this.quantity));
        }
    }
}
